...
export const ChallengeShowcase: React.FC<ChallengeShowcaseProps> = ({ language = "en" }) => {
  return (
    <div className="space-y-8 max-w-5xl mx-auto py-4">
      ...
      {/* Header Banner */}
      {/* Banner */}
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-emerald-300 dark:border-emerald-700 shadow-xl relative overflow-hidden space-y-4">
        <div className="absolute top-0 right-0 w-80 h-80 bg-emerald-100/50 dark:bg-emerald-950/30 rounded-full blur-3xl pointer-events-none"></div>

        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-900 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-700 text-xs font-bold">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-md space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-1.5">
            <span className="font-extrabold text-agri-700 dark:text-agri-400 text-sm block">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-1.5">
            <span className="font-extrabold text-purple-700 dark:text-purple-400 text-sm block">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-1.5">
            <span className="font-extrabold text-cyan-700 dark:text-cyan-400 text-sm block">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-md space-y-4">
        <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
          ...
          <h2 className="text-lg font-extrabold text-slate-900 dark:text-white">Requirement 2: Problem Statement & AI/ML Methodology</h2>
        </div>

        <div className="space-y-3 text-xs text-slate-800 dark:text-slate-200 leading-relaxed">
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700">
            <strong className="text-slate-900 dark:text-white block mb-1 text-sm font-extrabold">The Agricultural Problem in Karnataka:</strong>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700">
            <strong className="text-slate-900 dark:text-white block mb-1 text-sm font-extrabold">The AI/ML Approach:</strong>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-md space-y-4">
        <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
          ...
          <h2 className="text-lg font-extrabold text-slate-900 dark:text-white">Requirement 3: Practical Usefulness & Sustainability</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-2">
            ...
            <strong className="text-slate-900 dark:text-white block font-bold text-sm">Soil Rejuvenation</strong>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-2">
            ...
            <strong className="text-slate-900 dark:text-white block font-bold text-sm">Offline PWA Accessibility</strong>
            <p className="text-slate-600 dark:text-slate-300 font-medium">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-2">
            ...
            <strong className="text-slate-900 dark:text-white block font-bold text-sm">Organic Remedy Push</strong>
            <p className="text-slate-600 dark:text-slate-300 font-medium">
